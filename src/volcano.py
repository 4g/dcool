...
static_line((225+200, 400), (175+200, 400), 15).color=Color('grey')
static_line((225+200, 400), (225+200, 300), 15).color=Color('grey')
static_line((175+200, 300), (175+200, 400), 15).color=Color('grey')
static_line((220+200, 275), (225+200, 300), 15).color=Color('grey')
static_line((175+200, 300), (180+200, 275), 15).color=Color('grey')
...
for i in range(500):
    ball1 = ball((400 + random.randint(-1, 1), 350 + random.randint(-1, 1)), 5)
    # ball1.color = Color(random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
